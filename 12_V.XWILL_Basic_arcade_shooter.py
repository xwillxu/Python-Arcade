...
class SpaceShooter(arcade.Window):
    ...
    def setup(self):
        ...
        arcade.schedule(self.add_cloud, 0.2)

        # Behind this is some space is nothing instead of code i think that i can not use.
        #
        #
        #
        #
    ...
    def add_enemy(self, delta_time: float):
        ...
        enemy = FlyingSprite(
            "RealPython/materials/arcade-a-primer/images/missile.png", SCALING)
    ...
    def add_cloud(self, delta_time: float):
        ...
        cloud = FlyingSprite(
            "RealPython/materials/arcade-a-primer/images/cloud.png", SCALING)
